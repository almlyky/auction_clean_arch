  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return PostCard(post: post, mode: mode);
      },
    );
  }
}
...
class PostCard extends StatelessWidget {
  final PostCardMode mode;
  const PostCard({super.key, required this.post, required this.mode});
                        ...
                        child: Row(
                          children: [
                            _ActionIcon(
                              ...
                              onTap: () {
                                context
                                    .read<PostImagesCubit>()
                                    .initPostImageData(post.images!);
                                context.read<AddUpdatePostCubit>().initPostData(
                                  post,
                                );
                                context
                                    .read<CategoryCubit>()
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              context.read<PostCubit>().timeAgo(
                                post.createdAt!,
                              ),
                              // style: TextStyle(
    ...
    builder: (_) => AlertDialog(
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          onPressed: () {
            context.read<AddUpdatePostCubit>().deletePosts(postId);
